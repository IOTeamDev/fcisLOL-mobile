                                          ...
                                          if (MainCubit.get(context)
                                            ...
                                            return Builder(builder: (context) {
                                              ...
                                              return Row(
                                                ...
                                                children: [
                                                  RichText(text: TextSpan(text: 'Score: ', children: <TextSpan> [TextSpan(text: score4User!.score.toString() , style: TextStyle(color: isDark ? Colors.white : Colors.black, fontSize: 16, fontWeight: FontWeight.bold),)]),),
                                                  SizedBox(
                                                    width: 100,
                                                  ),
                                                  if (MainCubit.get(context)
