                  ...
                  (
                    ...
                    (
                      ...
                      [
                                        ...
                                        child: Row(
                                          children: [
                                            ElevatedButton(
                                              ...
                                              child: const Text('Canel'), style: ElevatedButton.styleFrom(padding: const EdgeInsetsDirectional.symmetric(horizontal: 35),  backgroundColor: HexColor('D9D9D9').withOpacity(0.2), foregroundColor: Colors.white, textStyle: TextStyle(fontSize: 15),),
                                            ),
                                            const Spacer(),
                                            ElevatedButton(
                                              onPressed: (){
                                              ...
                                              child: const Text('Submit'), style: ElevatedButton.styleFrom(padding: const EdgeInsetsDirectional.symmetric(horizontal: 40), backgroundColor: HexColor('B8A8F9'), foregroundColor: Colors.white, textStyle: TextStyle(fontSize: 15),)
                                            ),
                                          ],
                                        ),
                                      ),
                        ...
                        ConditionalBuilder(
                          condition: state is! AdminGetAnnouncementLoadingState && cubit.announcements != null,
            ...
            children: [
              ConstrainedBox(
                constraints: BoxConstraints(maxWidth: screenWidth(context) - 140),
                  child:  Text('$title', style: const TextStyle(fontSize: 20, color: Colors.white), maxLines: 1, overflow: TextOverflow.ellipsis,),
              ),
              Spacer(),
              MaterialButton(
                onPressed: () {
