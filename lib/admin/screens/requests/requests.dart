                    ...
                    Expanded(
                      child: ConditionalBuilder(
                        ...
                        fallback: (context)
                        {
                          ...
                          return const Center(child: Text('You have no requests yet!!!!!', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 40, color: Colors.white),textAlign: TextAlign.center,),);
                        },
                      ),
                    ),
                  ],
        ...
        [
          ...
          Padding(
            ...
            child: Row(
              children:
              [
                CircleAvatar(backgroundImage: NetworkImage(pfp.toString()), radius: 20,),
          ...
          Padding(
            ...
            child: Text(description, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white),),
          ),
                ...
                children: [
                  ...
                  ConstrainedBox(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        final linkElement = LinkableElement(link, link); // Create a LinkableElement
                  ...
                  MaterialButton(
                    onPressed: () {
                      AdminCubit.get(context).deleteMaterial(AdminCubit.get(context).requests![index].id!);
                    },
                    shape: const CircleBorder(), // Circular button
