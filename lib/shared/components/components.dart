...
Future<void> onOpen(BuildContext context, LinkableElement link) async {
  ...
  if (url.contains('facebook.com') || url.contains('drive.google.com') || url.contains('web.microsoftstream.com')) {
  ...
  Widget CustomDrawer(context, {required name, required semester, required photo, required role, required logout}) {
    return Drawer(
