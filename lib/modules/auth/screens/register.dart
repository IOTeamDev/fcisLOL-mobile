                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(color: isDark? Colors.grey: Colors.grey[600]),
                                      filled: true,
                                      suffixIcon: IconButton(icon: Icon(Icons.remove_red_eye, color: LoginCubit.get(context).hiddenPassword? isDark? Colors.grey: null: Colors.blue),onPressed: (){LoginCubit.get(context).togglePassword();},),
                                      fillColor: isDark? Colors.white:Colors.grey[350],
                                      border: OutlineInputBorder(
                                          borderRadius: BorderRadius.circular(20),
                                          borderSide: BorderSide.none
