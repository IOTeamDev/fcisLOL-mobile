              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color:
                          isDark ? HexColor('#3B3B3B') : HexColor('#757575')),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Text(
                          ...
                          child: RichText(
                            text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                      text:
                                          ' app is an interactive platform where study materials are collected, allowing students to contribute content for all academic years. Admins review and approve submissions to ensure quality. The development team is from the Faculty of Information and Computer Science at Ain Shams University (FCIS 2027).',
                                      style: TextStyle(
                                        fontSize: width / 20,
                ...
                Padding(
                  padding:
                      const EdgeInsetsDirectional.only(start: 20.0, bottom: 10),
                  child: Align(
