...
class _EditAnnouncementState extends State<EditAnnouncement> {
  ...
  void initState() {
    ...
    _dateController = TextEditingController(
        text: widget.date == 'No Due Date'
            ? 'Due Date'
            : intl.DateFormat('dd/MM/yyyy').format(DateTime.parse(widget.date)));
  ...
  Widget build(BuildContext context) {
    ...
    final content = widget.content.isEmpty ? StringsManager.noContent : widget.content;
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Container(
                  margin: const EdgeInsetsDirectional.symmetric(horizontal: 15, vertical: 40),
                                ...
                                if (value != null) {
                                  setState(() {
                                    ...
                                    dueDateFormatted = DateTime.utc(
                                      selectedDate.year,
                                      selectedDate.month,
                                      selectedDate.day).toIso8601String();
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    padding: EdgeInsetsDirectional.symmetric(horizontal: AppQueries.screenWidth(context) / 11),
