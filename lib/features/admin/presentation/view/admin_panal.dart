...
class AdminPanel extends StatelessWidget {
    ...
    return MultiBlocProvider(
      ...
      child: BlocConsumer<MainCubit, MainCubitStates>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: AppBar(
              title: Text(StringsManager.admin, style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeightManager.semiBold),),
              centerTitle: true,
            ),
            body: Center(
              child: Column(
                ...
                children: [
                  ...
                  ConditionalBuilder(
                    ...
                    builder: (context) => Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        buttonBuilder(context, mainCubit, ColorsManager.white, ColorsManager.darkPrimary, ColorsManager.darkPrimary, ColorsManager.lightGrey, IconsManager.campaignIcon, StringsManager.announcements, AddAnnouncement(semester: mainCubit.profileModel!.semester)),
                        ...
                        buttonBuilder(context, mainCubit, ColorsManager.white, ColorsManager.darkPrimary, ColorsManager.lightPrimary, ColorsManager.lightPrimary, IconsManager.emailIcon, StringsManager.requests, Requests()),
                        // Container(
                        //   height: 13,
  ...
  Widget buttonBuilder(context, mainCubit, containerDarkThemeColor, containerLightThemeColor, buttonDarkThemeColor, buttonLightThemeColor, icon, title, navigationWidget) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(
