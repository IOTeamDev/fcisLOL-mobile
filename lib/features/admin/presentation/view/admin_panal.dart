        ...
        return Scaffold(
          ...
          body: Center(
            child: Column(
              ...
              children: [
                // Buttons
                buttonBuilder(context, mainCubit, ColorsManager.white, ColorsManager.lightGrey1, ColorsManager.darkPrimary, ColorsManager.lightGrey, IconsManager.campaignIcon, StringsManager.announcements, AddAnnouncement(semester: mainCubit.profileModel!.semester)),
                SizedBox(height: AppSizesDouble.s30,),
                buttonBuilder(context, mainCubit, ColorsManager.white, ColorsManager.lightGrey1, ColorsManager.lightPrimary, ColorsManager.lightPrimary, IconsManager.emailIcon, StringsManager.requests, Requests()),
              ],
            ),
          ),
        );
