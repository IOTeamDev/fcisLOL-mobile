...
class PreviousExamsGenerator extends StatelessWidget {
  ...
  PreviousExamsGenerator(
      {super.key, required this.semester, required this.previousExamList});
  ...
  Widget build(BuildContext context) {
    return SliverList.separated(
      itemBuilder: (context, index) {
        ...
        return previousExamsBuilder(context, previousExamList[reversedIndex],
            MainCubit.get(context).profileModel?.role ?? 'STUDENT', semester);
      },
