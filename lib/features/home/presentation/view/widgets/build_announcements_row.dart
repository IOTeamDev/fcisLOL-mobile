        ...
        return InkWell(
          onTap: () => navigate(
            ...
            AnnouncementDetail(
              ...
              semester: AppConstants.TOKEN != null ? MainCubit.get(context).profileModel!.semester : AppConstants.SelectedSemester!,
            )
          ),
              ...
              child: Padding(
                ...
                child: Stack(
                  children: [
                    Text(
                      announce.title,
                      style: Theme.of(context).textTheme.headlineSmall!.copyWith(foreground: Paint()..style = PaintingStyle.stroke..strokeWidth = AppSizesDouble.s1_8..color = ColorsManager.black),
