                      ...
                      children: [
                              ...
                              if (AdminCubit
                                ...
                                return CarouselSlider(
                                      ...
                                      child: Stack(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Image.network(
                                                announc.image,
                                                width: AppSizesDouble
                                                    .s400,
                                                height: AppSizesDouble
                                                    .s250,
                                                fit: BoxFit.cover,
                                              ),
                                            ), //image
                                  ...
                                  options: CarouselOptions(
                                    ...
                                    announcements.length < AppSizes.s5
                                        ? false
                                        : true,
                                    ...
                                    const Duration(
                                        milliseconds: AppSizes.s800),
                                    viewportFraction: announcements.isEmpty
                                        ? AppSizesDouble.s1
                                        : AppSizesDouble.s0_8,
                                  ),
                                );
                        ...
                        Padding(
                          ...
                          child: GridView.builder(
                            ...
                            shrinkWrap:
                            true,
                            // Shrink the GridView to fit its content
                            gridDelegate:
                ...
                children: [
                  ...
                  ExpansionTile(
                    ...
                    shape: RoundedRectangleBorder(
                        borderRadius:
                        BorderRadius.zero),
                    // Removes divider when expanded
                    collapsedShape: RoundedRectangleBorder(
                        borderRadius:
                        BorderRadius.zero),
                    // Removes divider when collapsed
                    children: [
                      ExpansionTile(
                        title: Text(
