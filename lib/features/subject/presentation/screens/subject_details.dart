...
class SubjectDetails extends StatefulWidget {
  ...
  final bool navigate;
  const SubjectDetails({super.key, required this.subjectName, required this.navigate});

  @override
  State<SubjectDetails> createState() => _MaterialDetailsState();
}

class _MaterialDetailsState extends State<SubjectDetails> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        margin: EdgeInsetsDirectional.only(top: AppQueries.screenHeight(context) / AppSizes.s15),
        child: Column(
          children: [
            Padding(
              padding: EdgeInsets.symmetric(horizontal: AppPaddings.p16, vertical: AppPaddings.p10),
              child: TextField(
                onChanged: (query) {
