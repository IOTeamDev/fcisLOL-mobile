        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: IconButton(onPressed: () => Navigator.pop(context), icon: Icon(IconsManager.backIcon, color: ColorsManager.black,)),
              backgroundColor: ColorsManager.white,
              title: Text(StringsManager.profileImage, style: Theme.of(context).textTheme.displayMedium!.copyWith(color: ColorsManager.black)),
              centerTitle: true,
            ),
            body: Center(
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: mainCubit.userImageFile != null ? FileImage(mainCubit.userImageFile!) : AssetImage(AppConstants.noneLoggedInDefaultImage),
                   ),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if(mainCubit.userImageFile == null){
                          if (noMoreStorage!) {
                            showToastMessage(message: "no more space available :)", states: ToastStates.WARNING);
                          } else {
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(mainCubit.imageName!, style: Theme.of(context).textTheme.titleLarge!.copyWith(color: ColorsManager.black)),
                          SizedBox(width: AppSizesDouble.s10,),
                          Icon(mainCubit.pickerIcon,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        widget.userInfo.photo = mainCubit.userImagePath ?? "https://firebasestorage.googleapis.com/v0/b/fcis-da7f4.appspot.com/o/images%2Fdefault-avatar-icon-of-social-media-user-vector.jpg?alt=media&token=5fc138d2-3919-4854-888e-2d8fec45d555";
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(StringsManager.next, style: Theme.of(context).textTheme.titleLarge!.copyWith(color: ColorsManager.white)),
                          SizedBox(width: AppSizesDouble.s10,),
                          Icon(IconsManager.leftArrowIcon, color: ColorsManager.white, size: AppSizesDouble.s30,)
                        ],
                      ),
                    ),
                  ),
