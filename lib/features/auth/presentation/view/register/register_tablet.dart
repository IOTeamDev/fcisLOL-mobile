...
//   @override
//   State<RegisterTablet> createState() => _RegisterscreenState();
// }

// class _RegisterscreenState extends State<RegisterTablet> {
...
//                     _nameController, AppStrings.fullName, TextInputType.name,
...
//                   height: AppSizesDouble.s15,
//                 ),
//                 defaultLoginInputField(_phoneController, AppStrings.phoneNumber,
//                     TextInputType.phone,
//                     textInputAction: TextInputAction.next),
//                 const SizedBox(
//                   height: AppSizesDouble.s15,
...
//                         AppStrings.password, TextInputType.visiblePassword,
//                         isPassword: true,
//                         loginCubit: AuthCubit.get(context),
...
//                       validationMessage: AppStrings.passwordNotMatchingError,
//                       validator: (value) {
//                         if (value!.isEmpty) {
//                           return AppStrings.emptyFieldWarning;
...
//                   height: AppSizesDouble.s15,
//                 ),
//                 defaultLoginButton(context, _formKey, AuthCubit.get(context),
//                     _emailController, _passwordController, AppStrings.signup,
