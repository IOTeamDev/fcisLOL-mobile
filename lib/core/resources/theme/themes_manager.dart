...
import 'package:lol/core/resources/styles_manager.dart';
import '../assets/fonts_manager.dart';
...
ThemeData lightTheme = ThemeData(
  ...
  progressIndicatorTheme:
      ProgressIndicatorThemeData(color: ColorsManager.black),
  ...
  textTheme: TextTheme(
    displayLarge:
        getBoldStyle(color: ColorsManager.black, fontSize: FontSize.size30),
    displayMedium:
    ...
    bodySmall:
        getRegularStyle(color: ColorsManager.black, fontSize: FontSize.size12),
  ),
);
...
ThemeData darkTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    bodySmall:
        getRegularStyle(color: ColorsManager.white, fontSize: FontSize.size12),
  ),
);
